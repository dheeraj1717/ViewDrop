/**
 * Lightweight WebM EBML Duration Fixer (yusitnikov/fix-webm-duration)
 * Resolves the Chrome "infinite/missing duration" seek bug by correctly rewriting the EBML headers.
 */
(function (name, definition) {
    if (typeof define === 'function' && define.amd) { // RequireJS / AMD
        ...
        window.fixWebmDuration = window.ysFixWebmDuration; // Also expose as fixWebmDuration for recorder.js
    }
        ...
        try {
            ...
            reader.onloadend = function() {
                try {
                    ...
                    console.error('[fix-webm-duration] Error parsing WebM file:', ex);
                }
                callback(blob);
            };
